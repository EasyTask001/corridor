...
select r.id, p.id from public.roles r, public.permissions p
  where r.is_system and r.name = 'Owner'
    and p.key in ('organization.read', 'organization.manage', 'organization.members.read', 'organization.members.manage', 'organization.roles.manage', 'billing.read', 'billing.manage', 'integrations.manage', 'audit_log.read', 'driver.read', 'driver.write', 'truck.read', 'truck.write', 'trailer.read', 'trailer.write', 'partner.read', 'partner.write', 'movement.read', 'movement.write', 'movement.transmit_to_customs', 'movement.amend', 'movement.cancel', 'movement.read_assigned', 'document.read', 'document.upload', 'document.review_extraction', 'alert.read', 'alert.manage', 'report.read', 'copilot.use');
...
select r.id, p.id from public.roles r, public.permissions p
  where r.is_system and r.name = 'Admin'
    and p.key in ('organization.read', 'organization.manage', 'organization.members.read', 'organization.members.manage', 'organization.roles.manage', 'billing.read', 'integrations.manage', 'audit_log.read', 'driver.read', 'driver.write', 'truck.read', 'truck.write', 'trailer.read', 'trailer.write', 'partner.read', 'partner.write', 'movement.read', 'movement.write', 'movement.transmit_to_customs', 'movement.amend', 'movement.cancel', 'movement.read_assigned', 'document.read', 'document.upload', 'document.review_extraction', 'alert.read', 'alert.manage', 'report.read', 'copilot.use');
...
select r.id, p.id from public.roles r, public.permissions p
  where r.is_system and r.name = 'Dispatcher'
    and p.key in ('organization.read', 'driver.read', 'driver.write', 'truck.read', 'truck.write', 'trailer.read', 'trailer.write', 'partner.read', 'partner.write', 'movement.read', 'movement.write', 'movement.transmit_to_customs', 'movement.amend', 'movement.cancel', 'document.read', 'document.upload', 'document.review_extraction', 'alert.read', 'alert.manage', 'report.read', 'copilot.use');
...
select r.id, p.id from public.roles r, public.permissions p
  where r.is_system and r.name = 'Compliance Officer'
    and p.key in ('organization.read', 'organization.members.read', 'billing.read', 'audit_log.read', 'driver.read', 'truck.read', 'trailer.read', 'partner.read', 'movement.read', 'document.read', 'alert.read', 'report.read', 'alert.manage', 'document.review_extraction', 'copilot.use', 'movement.amend');
...
select r.id, p.id from public.roles r, public.permissions p
  where r.is_system and r.name = 'Read-Only'
    and p.key in ('organization.read', 'organization.members.read', 'billing.read', 'audit_log.read', 'driver.read', 'truck.read', 'trailer.read', 'partner.read', 'movement.read', 'document.read', 'alert.read', 'report.read');
