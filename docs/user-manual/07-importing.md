...
2. **Validate**: every line gets a verdict. Partners are matched by name, ports by code, carrier codes against the ones on file. Duplicate control numbers, in the file or already in Corridor, are errors.
